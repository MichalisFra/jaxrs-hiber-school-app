...
import gr.aueb.cf.schoolapp.core.EntityInvalidArgumentException;
...
//                throw new EntityAlreadyExistsException("Teacher","Teacher with vat: " +
...
//            }
            ...
            teacherDAO.getById(updateDTO.getVat()).orElseThrow(() -> new EntityNotFoundException("Teacher", "Teacher with VAT: " + updateDTO.getVat() + " not found"));

            teacherDAO.getById(updateDTO.getId()).orElseThrow(() -> new EntityNotFoundException("Teacher", "Teacher with ID: " + updateDTO.getId() + " not found"));
